...
#-------------------------ADD RECORDING-------------------------#
    ...
    def add_record(self, patient_id):
        ...
        formatted_datetime = current_datetime.toString("yyyyMMddTHH:mm:ss")
        ...
        if user:
            ...
            text_url = self.convert_wav_to_text(recording_url)
            print(text_url)
            ...
            new_recording_ref.set({
                "confidence": ml_output,
                "date_recorded" : formatted_datetime,
                "phrase": phrase,
                "doctor_note": notes,
                "wav_url": recording_url,
                "text_url" : text_url
            })
        else:
            print("No user is currently logged in.")
